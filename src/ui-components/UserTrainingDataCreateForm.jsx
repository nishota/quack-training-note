...
export default function UserTrainingDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTrainingDataId(initialValues.TrainingDataId);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UserTrainingData(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UserTrainingDataCreateForm")}
      {...rest}
    >
      <TextField
        label="User name"
