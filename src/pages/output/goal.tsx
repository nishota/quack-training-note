...
const dataFromServer: TableData = [
  {
    ...
    data: [
      { key: "1", values: ["1", "バーベル", "ベンチプレス", "40", "10", "60", "40", "10", "2023/8/26 6:06:41"] },
      { key: "2", values: ["2", "バーベル", "スクワット", "40", "10", "60", "40", "10", "2023/8/26 6:06:41"] },
      { key: "3", values: ["3", "バーベル", "デッドリフト", "40", "10", "60", "40", "10", "2023/8/26 6:06:41"] },
    ]
  },
]
